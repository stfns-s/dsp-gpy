...
# testbench drives modules/<name>.svpy, while a function testbench includes its function
...
inputs=(--input "${tb}.svpy")
synthtop=()
if [[ -f "${MODDIR}/${func}.svpy" ]]; then
    inputs+=(--input "${func}.svpy")
